        ...
        <div className="md:flex md:items-center md:justify-between">
          <div className="md:w-1/2 mb-8 md:mb-0">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button className="bg-white text-blue-900 px-6 py-3 rounded-lg font-bold hover:bg-gray-100 flex items-center justify-center">
                Shop Protein
                <ChevronRight size={20} className="ml-2" />
              </button>
              <button className="bg-transparent border-2 border-white px-6 py-3 rounded-lg font-bold hover:bg-white/10 flex items-center justify-center">
                Equipment
                <ChevronRight size={20} className="ml-2" />
              </button>
            </div>
